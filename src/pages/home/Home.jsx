...
const Home = () => {
  ...
  const handleMouseMove = (e) => {
    ...
    if (astronaut) {
      astronaut.style.transform = `translate(calc(-50% + ${
        mouseX * 15 - 7.5
      }px), calc(-50% + ${mouseY * 15 - 7.5}px))`;
    }
  };
  ...
  return (
    <div id="main-content" className="w-full h-full">
      ...
      >
        {/* Glow Overlay */}
        <div
          className="absolute inset-0 z-10 pointer-events-none animate-glow-pulse bg-radial-gradient"
          style={{
            background:
              "radial-gradient(ellipse at 50% 20%, rgba(255, 150, 50, 0.3) 0%, transparent 50%)",
          }}
        />
        ...
        <div
          className="orbit-ring absolute w-[300px] h-[300px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border border-white/10 rounded-full animate-rotate-orbit pointer-events-none hidden md:block md:w-[450px] md:h-[450px]"
